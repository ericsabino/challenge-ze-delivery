...
public class GlobalHandlerException extends ResponseEntityExceptionHandler {
    ...
    @ResponseBody
    protected ApiError handleInternalServerError(WebRequest request, Exception ex) {
        return new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, ex.getLocalizedMessage(), Arrays.asList(ex.getMessage()));
    }
}
